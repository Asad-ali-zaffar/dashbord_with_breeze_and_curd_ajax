...
<div class="card card-primary">
    <div class="card-header">
      <h3 class="card-title">{{__('Edit Product Method Entry')}}</h3>
    </div>
    <!-- /.card-header -->
    <form method="POST" action="{{route('admin.product_method_entry.update',$patient->id)}}"  enctype="multipart/form-data"  id="form">
        <!-- /.card-header -->
        <div class="card-body">
            @csrf
            @method('put')
